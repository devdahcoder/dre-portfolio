...
const Contact = (props: Props) => {
    ...
    createEffect(() => {
        ...
        elementObserver(sectionRef, (entry, observer) => {
    ...
    return (
        ...
        >
            <div class="contact--sub--container">
                ...
                <div
                    class="text-5xl font-bold font-cabinetgrotesk bg-gradient-to-b from-slate-600 to-slate-300 bg-clip-text text-transparent">
                    <ParallaxCharacter
