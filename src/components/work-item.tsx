...
const WorkItem = (props: Props) => {
	...
	return (
		...
		>
			...
			<divclass="flex flex-row items-center flex-wrap gap-x-2 relative md:absolute md:-left-36 lg:-left-56 md:top-5 text-4xl sm:text-5xl font-semibold bg-gradient-to-l from-zinc-900 to-gray-100 bg-clip-text text-transparent w-full max-w-[70%] sm:max-w-full">
			...
			<divclass="hidden md:block relative md:absolute top-5 -right-60 w-full max-w-xs text-lg font-normal text-white">
				<p>{detail}</p>
			</div>
		</motion.div>
	);
